...
ok2Region = Region(900, 730, 120, 300)
replayRegion = Region(900, 770, 400, 300)
...
refillYesRegion = Region(550, 500, 400, 300)
refillNoRegion = Region(1276, 148, 300, 300)
notEnoughEnergyRegion = Region(900, 300, 300, 150)
notEnoughWingRegion = Region(850, 355, 260, 65)
rechargeFlashRegion = Region(649, 334, 300, 300)
yesPurchaseRegion = Region(745, 635, 110, 60)
okPurchaseRegion = Region(915, 625, 90, 60)
closePurchaseRegion = Region(1652, -.33, 300, 300)
...
function dialogBox()
  ...
  dialogShowFullScreen("Summoners War Palbot")
end
...
function refill()
  if refillEnergy then
    ...
    refillYesRegion:existsClick(Pattern("yesRecharge.png"):similar(imgAccuracy * 0.7), 3)
...
function victory()
  ...
  if not okRegion:existsClick(Pattern("ok.png"):similar(imgAccuracy), 1.5) then
    sellGetRune()
       if ok2Region:existsClick(Pattern("ok2.png"):similar(imgAccuracy), 1.5) then
      end
  end
end
...
while true do
  ...
  elseif not runLiveArena or not runQuickClick or not runRiftRaid then
    ...
    if closePurchaseRegion:existsClick(Pattern("closePurchaseNew.png"):similar(imgAccuracy), 0.1) then
    end
